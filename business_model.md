...
- **Every tier now carries real cover, not just the top one.** Every
  provider above caps between R226,600 and R385,000 per case/year - none
  of them zero out cover on their cheaper tiers the way LegalInsure's
  original design did. Basic (R100,000) and Premium (R250,000) were
  given real limits below Ultimate (kept at R500,000, a deliberate
  above-market position for the flagship tier) specifically to close
  that gap - see §3.
...
|---|---|---|---|---|
| Basic | R99/mo | 0 | Up to R100,000/year | AI guidance + document templates, plus real litigation cover |
| Premium | R199/mo | 2/month | Up to R250,000/year | Real attorney access and a higher cover limit |
| Ultimate | R399/mo | Unlimited | Up to R500,000/year | Full legal expense cover |

Every tier carries a real, nonzero cover limit - lower tiers get a lower
cap, not zero. This was a deliberate correction: the original design gave
Basic/Premium no cover limit at all, which meant a claim on either tier
could be marked "Approved" while no money moved for the client - a
contradiction (approving a claim should always mean the insurer is
paying to fix the problem), and one no researched competitor's pricing
actually works this way either (see Competitor Landscape above - every
provider checked scales cover *down* by tier, never to zero).
...
- **Indemnity benefit → Claims.** We pay (or reimburse) actual litigation/
  ...
  process in §5. Available on every tier now that every tier has a real
  limit - not an Ultimate-only benefit.
