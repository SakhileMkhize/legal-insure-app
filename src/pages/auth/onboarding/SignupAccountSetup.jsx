...
export function SignupAccountSetup() {
  ...
  const formik = useFormik({
    initialValues: { password: "", confirmPassword: "", acceptTerms: false },
    validationSchema,
        ...
        <Box component="form" onSubmit={formik.handleSubmit} noValidate>
          <Stack spacing={2.5}>
            ...
            {formik.touched.acceptTerms && formik.errors.acceptTerms && (
              <Typography variant="caption" color="error">{formik.errors.acceptTerms}</Typography>
            )}

            <Stack direction="row" spacing={2}>
              <Button variant="outlined" onClick={() => navigate("/signup/plan")} fullWidth>
                Back
              </Button>
              <Button
                type="submit"
