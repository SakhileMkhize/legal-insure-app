...
export function PlanCard({ plan, selected = false, compact = false, onSelect, actionLabel = "Get Started" }) {
  ...
  return (
    <Card
      ...
      sx={{
        ...
        borderColor: selected ? "secondary.main" : plan.popular ? "primary.main" : "divider",
